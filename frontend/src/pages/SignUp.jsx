        ...
        <div className='w-full min-h-[100vh] bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center p-4'>
            <div className='w-full max-w-[420px] bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden'>
                ...
                <div className='w-full px-8 pt-10 pb-8 bg-gradient-to-r from-[#1EA7E0] to-[#20c7ff] flex flex-col items-center gap-3'>
                    ...
                    <h1 className='text-white font-bold text-[24px] tracking-tight'>Welcome to Chatly</h1>
                    <p className='text-white/80 text-[14px] -mt-1'>Create an account to get started</p>
                </div>

                {/* Form */}
                <form className='w-full flex flex-col gap-5 px-8 py-8' onSubmit={handleSignUp}>

                    <div className='flex flex-col gap-1.5'>
                        <label className='text-slate-600 text-[13px] font-medium ml-1'>Username</label>
                    ...
                    <p className='text-center text-slate-500 text-[14px] mt-2 cursor-pointer' onClick={() => navigate("/login")}>
                        Already have an account? <span className='text-[#20c7ff] font-semibold'>Login</span>
                    </p>
                </form>
            </div>
        </div>
